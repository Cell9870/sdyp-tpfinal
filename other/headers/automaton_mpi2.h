...
short ruleB();
void updateGrid(Node**, Node**, int, int, int, int[], MPI_Datatype, int);
void manualGatherGrid(Node**, Node**, int, int, int, int[], MPI_Datatype);
int getDistance(int, int);
int inGrid(int, int);
void copyGrid(Node**, Node**);
void showGrid(Node**);
void updateRows(Node**, Node**, int, int, MPI_Datatype, int, int[]);
int isMyUpRow(int, int);
int isMyUpNeighborRow(int, int);
int isMyDownRow(int, int);
int isMyDownNeighborRow(int, int);
void divideAndSendGrid(Node**, Node**, int, int, MPI_Datatype, int, int[]);
